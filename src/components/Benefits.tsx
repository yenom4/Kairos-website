      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-humanoid">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          <div className="mb-2 md:mb-3">
            <div className="flex items-center gap-4 mb-4 md:mb-4 pt-8 sm:pt-6 md:pt-4">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            opacity: isFirstCardVisible ? 0.9 : 0
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Résultats garantis</span>
                </div>
              </div>
              
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">Triplez vos leads qualifiés tout en libérant des heures de prospection manuelle.</h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isSecondCardVisible ? 'auto' : 'none'
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">Doublez votre taux de conversion sans effort supplémentaire.</h3>
                </div>
              </div>
            </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="w-full">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Plus de temps, plus de clients :<br/>
                    accélérez naturellement<br/>
                    <span className="text-[#FC4D0A]">votre croissance</span>
                  </h3>
                </div>
              </div>
            </div>
