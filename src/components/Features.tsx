...
const Features = () => {
  ...
  return <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features">
      <motion.div 
      ...
      >
        <div className="text-center mb-10 sm:mb-16">
          ...
          <motion.p className="section-subtitle mx-auto" variants={itemVariants}>Nous automatisons votre acquisition client de A à Z pour que vous vous concentriez sur l'essentiel : faire grandir votre entreprise.</motion.p>
        </div>
